...
public class NearbyAdapter extends BaseAdapter {
	...
	public NearbyAdapter(List<IntroData> shopintro,Context context) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		vh = new ViewHolder();
		if(convertView ==null){
			convertView = LayoutInflater.from(context).inflate(R.layout.refindintro
					, null);
			vh.text2 = 	(TextView) convertView.findViewById(R.id.textView1);
			vh.text3 = 	(TextView) convertView.findViewById(R.id.textView2);
			vh.text4 = 	(TextView) convertView.findViewById(R.id.textView3);
		...
		if(shopintro.get(0).getListvalue().get(position).getValue().length()>9){
			vh.text3.setText("");
			vh.text4.setText(shopintro.get(0).getListvalue().get(position).getValue());
		}else{
			vh.text4.setText("");
