...
public class Myoneadpater  extends BaseAdapter{
	private  List<Myone> strs;
	private Context context;
	private ViewHolder vh;
	public Myoneadpater(List<Myone> strs, Context context) {
		super();
		this.strs = strs;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		vh = new ViewHolder();
		if(convertView ==null){
			convertView = LayoutInflater.from(context).inflate(R.layout.home_list
					, null);
	...
	*/
	public static void setListViewHeightBasedOnChildren(ListView listView) {
	    ...
	    Myoneadpater  listAdapter = (Myoneadpater) listView.getAdapter();
	    if (listAdapter == null) {
	        // pre-condition
	        return;
	    }
