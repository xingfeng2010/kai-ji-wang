...
public class FindTwocompany extends Activity {
	...
	private void initView() {
		...
		hla =new Myoneadpater(arrlist, FindTwocompany.this);
	...
	OnItemClickListener ocl =new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			switch(arg2){
			case 0:
				Intent it0= new Intent(FindTwocompany.this,FindFouractivity.class);
//				it0.putExtra("key", str[0]);
				startActivity(it0);
				break;
			case 1:
				Intent it1= new Intent(FindTwocompany.this,FindFouractivity.class);
//				it1.putExtra("key", str[1]);
				startActivity(it1);
				break;
			case 2:
				Intent it2= new Intent(FindTwocompany.this,FindFouractivity.class);
