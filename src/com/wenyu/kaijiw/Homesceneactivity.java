...
public class Homesceneactivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sp1.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
					int arg2, long arg3) {
			hla =new Home_List_Adapter(lists, Homesceneactivity.this);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent it1= new Intent(Homesceneactivity.this,Nearby.class);
				startActivity(it1);
			}
		});
	};
...
//		}
	...
	private void iffun() {
		...
		if(int1.equals("1")){
			scan.setText("影棚");
			collect.setText("实景");
			a = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item, att);
		...
		}else if(int1.equals("2")){
			scan.setText("店家");
			collect.setText("器材");
			adapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,att);
			sp1.setAdapter(adapter);
			sp1.setOnItemSelectedListener(ols);
			a= new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item, att);
			sp2.setAdapter(a);
			sp2.setOnItemSelectedListener(ols);
			adapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.spinner2) );
			sp3.setAdapter(adapter);
			sp3.setOnItemSelectedListener(ols);
		}else if(int1.equals("3")){
			scan.setText("店家");
			collect.setText("器材");
			adapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,att);
			sp1.setAdapter(adapter);
	 ...
	 OnItemSelectedListener  ols  = new   OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Toast.makeText(Homesceneactivity.this, "第二个", 1000).show();
				break;
