...
public class Publistissue extends Activity{
	...
	Handler handler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			switch(msg.what){
			case 1:
				 pas = new  PublishStudioNoImageAdapter(pubs, Publistissue.this);
	...
	mListView.setOnItemClickListener(new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				long arg3) {
		Intent intent = new Intent(Publistissue.this,PublishSssueAdd.class);
...
//					paramsValue.put("type_str","演播棚");
					if(NetWorkUtil.isNetAvailable(Publistissue.this)){
						ss = new HttpP().sendPOSTRequestHttpClient(url.trim(),paramsValue);
//						System.out.println("影视碰添加 的数据"+url+paramsValue);
...
//		  item_price ：器材价格
		...
		equtype = getIntent().getStringExtra("name");
	...
	OnClickListener ocl =new OnClickListener() {
		...
		public void onClick(View arg0) {
			switch(arg0.getId()){
			case R.id.textView2:
				Intent publishstudioadd =  new Intent(Publistissue.this,PublishlistissueAdd.class);
