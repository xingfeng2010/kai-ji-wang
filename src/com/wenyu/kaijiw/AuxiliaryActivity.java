...
import com.wenyu.kaijiw.fragment.AuxiliaryEquipmentFragment;
import com.wenyu.kaijiw.fragment.AuxiliaryStoreFragment;
 ...
 *
 */
public class AuxiliaryActivity extends FragmentActivity {
	private List<Fragment> li;
	private AuxiliaryStoreFragment fs;
	private AuxiliaryEquipmentFragment fsc;
	...
	private void initView() {
		...
		sm.pushActivity(AuxiliaryActivity.this);
		...
		fs = new AuxiliaryStoreFragment();
		fsc =  new AuxiliaryEquipmentFragment();
		li.add(fs);
		li.add(fsc);
