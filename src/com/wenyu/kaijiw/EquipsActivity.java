...
public class EquipsActivity extends Activity {
	private RadioButton scan,collect;
	private Spinner sp1,sp2,sp3;
	private ArrayAdapter<String> adapter,a;
	private ListView listview;
	private String[] arr ={"恒艺影视器材","友缘影视器材","金色号角"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sp1.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
					int arg2, long arg3) {
			hla =new Home_List_Adapter(lists, EquipsActivity.this);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent it1= new Intent(EquipsActivity.this,EquipsDetail.class);
				startActivity(it1);
			}
		});
	};
...
//		}
	...
	private void iffun() {
		...
		if(int1.equals("2")){
			scan.setText("店家");
			collect.setText("器材");
			a = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.spinner2) );
			a.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
			sp1.setAdapter(a); 
			sp1.setOnItemSelectedListener(ols);
			a = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.spinner4) );
			a.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
			sp2.setAdapter(a);
			sp2.setOnItemSelectedListener(ols);
			a = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.spinner5) );
			a.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
			sp3.setAdapter(a);
	 ...
	 OnItemSelectedListener  ols  = new   OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Toast.makeText(EquipsActivity.this, "第二个", 1000).show();
				break;
