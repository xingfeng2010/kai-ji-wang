...
public class Findissuepublicity extends Activity {
	...
	Handler  handler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			switch(msg.what){
			case 1:
				CompanyDetailAdapter sa =new CompanyDetailAdapter(Findissuepublicity.this, lists);
	...
	private void initView() {
		...
		sm.pushActivity(Findissuepublicity.this);
	...
	OnItemClickListener ocl =new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				long arg3) {
			Intent it0= new Intent(Findissuepublicity.this,FindFouractivity.class);
