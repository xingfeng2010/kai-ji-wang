...
public class PublishStudioAdd extends Activity{
	...
	private void initView() {
		...
		sm.pushActivity(PublishStudioAdd.this);
	...
	OnClickListener ocl =new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			case R.id.textView2:
				Intent publishstudioadd =  new Intent(PublishStudioAdd.this,PublistStudio.class);
				startActivity(publishstudioadd);
				PublishStudioAdd.this.finish();
				sm.popAllActivityExceptOne(PublishStudioAdd.class);
				break;
			...
			case R.id.studiotypefirst:
				Intent it = new Intent(PublishStudioAdd.this,PersonInfoUpdateActivityPublish.class);
				it.putExtra("title", "影视类别");
				it.putExtra("is_list", true);
				it.putExtra("content", studiotypeedit.getText().toString());
				it.putExtra("f", "2");
				startActivityForResult(it, 2);
				break;
			case R.id.studionamesecond:
				Intent it1 = new Intent(PublishStudioAdd.this,PersonInfoUpdateActivityPublish.class);
				it1.putExtra("title", "影棚名称");
				it1.putExtra("content", studionameedit.getText().toString());
				it1.putExtra("f", "3");
				startActivityForResult(it1, 3);
				break;
			case R.id.studiocontactthird:
				Intent it2 = new Intent(PublishStudioAdd.this,PersonInfoUpdateActivityPublish.class);
			...
			case R.id.studiocontactphonefourth:
				Intent it4 = new Intent(PublishStudioAdd.this,PersonInfoUpdateActivityPublish.class);
			...
			case R.id.studiopricefifth:
				Intent it3 = new Intent(PublishStudioAdd.this,PersonInfoUpdateActivityPublish.class);
