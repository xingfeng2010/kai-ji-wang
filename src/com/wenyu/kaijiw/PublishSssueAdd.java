...
public class PublishSssueAdd extends Activity{
	private String url =ConstantClassField.SERVICE_URL +"service/addCDByCustomerIDAndEquParam";
	private ImageView back;
	private TextView text,add,studiotypeedit,studionameedit,studiocontactedit,studiophoneedit,studiopriceedit,studioname,studiotype;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		add.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				initThread();
				Intent publishstudioadd =  new Intent(PublishSssueAdd.this,Publistissue.class);
	...
	private void initView() {
		...
		studiotype=(TextView) findViewById(R.id.studiotype);
		studioname=(TextView) findViewById(R.id.studioname);
		studiotype.setText("实景类别");
		studioname.setText("实景名称");
	...
	OnClickListener ocl =new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			case R.id.imageView1:
				PublishSssueAdd.this.finish();
				break;
			case R.id.studiotypefirst:
				Intent it = new Intent(PublishSssueAdd.this,PersonInfoUpdateActivityPublish.class);
				it.putExtra("title", "实景类别");
				it.putExtra("content", studiotypeedit.getText().toString());
				it.putExtra("f", "2");
				startActivityForResult(it, 2);
				break;
			case R.id.studionamesecond:
				Intent it1 = new Intent(PublishSssueAdd.this,PersonInfoUpdateActivityPublish.class);
			...
			case R.id.studiocontactthird:
				Intent it2 = new Intent(PublishSssueAdd.this,PersonInfoUpdateActivityPublish.class);
			...
			case R.id.studiocontactphonefourth:
				Intent it4 = new Intent(PublishSssueAdd.this,PersonInfoUpdateActivityPublish.class);
			...
			case R.id.studiopricefifth:
				Intent it3 = new Intent(PublishSssueAdd.this,PersonInfoUpdateActivityPublish.class);
